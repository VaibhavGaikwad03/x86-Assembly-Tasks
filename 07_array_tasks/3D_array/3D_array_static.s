...
label_scan_for3_body:
    ...
    movl    -8(%ebp), %eax
    movl    -12(%ebp), %ecx
    mull    %ecx        # no of elements in 2D array
    movl    $4, %ecx    # size of element
    mull    %ecx        # size of 2D array
    movl    -16(%ebp), %ecx
    mull    %ecx
    leal    -50024(%ebp), %ebx
    addl    %eax, %ebx
    ...
    movl    -12(%ebp), %ecx     # no of elements in 1D array
    mull    %ecx                # size of 1D array
    movl    -20(%ebp), %ecx
    mull    %ecx
    addl    %eax, %ebx
